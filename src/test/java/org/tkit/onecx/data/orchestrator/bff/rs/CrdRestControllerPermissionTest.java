...
class CrdRestControllerPermissionTest extends AbstractTest {
    ...
    public void before() {
        ...
        client.resource(CrdRestControllerPermissionTest.class.getResourceAsStream("/mocks/permissionMock.yml")).create();
    }
